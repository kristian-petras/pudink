...
depressed = pyglet.resource.image("assets/ui/blue_button05.png")
pressed = pyglet.resource.image("assets/ui/blue_button04.png")
hover = pyglet.resource.image("assets/ui/blue_button05.png")
bar = pyglet.resource.image("assets/ui/bar.png")
knob = pyglet.resource.image("assets/ui/knob.png")
...
togglebutton = pyglet.gui.ToggleButton(
    100, 400, pressed=pressed, depressed=depressed, hover=hover, batch=batch
)
togglebutton.set_handler("on_toggle", toggle_button_handler)
frame.add_widget(togglebutton)
toggle_label = pyglet.text.Label(
    "Toggle Button: False", x=300, y=400, batch=batch, color=(0, 0, 0, 255)
)
...
push_label = pyglet.text.Label(
    "Push Button: False", x=300, y=300, batch=batch, color=(0, 0, 0, 255)
)
...
slider_label = pyglet.text.Label(
    "Slider Value: 0.0", x=300, y=200, batch=batch, color=(0, 0, 0, 255)
)
...
text_entry = pyglet.gui.TextEntry("Enter Name", 100, 100, 150, batch=batch)
window.push_handlers(text_entry)
text_entry.set_handler("on_commit", text_entry_handler)
text_entry_label = pyglet.text.Label(
    "Text: None", x=300, y=100, batch=batch, color=(0, 0, 0, 255)
)
